...
function CartaSection() {
  ...
  return (
    <section id="carta" className="py-24 px-6 md:px-16 bg-secondary">
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans antialiased" style={{ scrollBehavior: "smooth" }}>
      ...
      <main>
        ...
        {/* ── PRODUCTOS ── */}
        <section id="productos" className="py-24 px-6 md:px-16 bg-background">
          <div className="max-w-6xl mx-auto flex flex-col gap-12">
        ...
        <section id="eventos" className="py-24 px-6 md:px-16 bg-secondary overflow-hidden">
        ...
        {/* ── CONTACTO ── */}
        <section id="contacto" className="py-24 px-6 md:px-16 bg-secondary">
